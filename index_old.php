...
<title><?= APP_NAME ?> – Controle Financeiro</title>
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    ...
    <span class="logo-text">Finanças<span>PRO</span></span>
  </div>
...
async function loadTransacoes() {
  ...
  if (!rows.length) { tb.innerHTML = `<tr><td colspan="8"><div class="empty"><p>Nenhuma transação encontrada</p></div></td></tr>`; return; }
